---
id: P269
title: "Node-Referenz-Batch display: Display-Knoten (8): text, table, list, repeat, container, image, icon, avatar — (divider ist der P265-Pilot) — Guide-Doc (EN+DE) + 1–3 Import-Beispiele + locales-Hilfe (en-US+de) je Knoten"
epic: aspects/docs
status: pending
dependencies: [P265]
verify: browser
