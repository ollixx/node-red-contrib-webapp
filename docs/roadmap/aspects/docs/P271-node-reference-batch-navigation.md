---
id: P271
title: "Node-Referenz-Batch navigation: Navigations-Knoten (8): menu, breadcrumb, tabs, tab, accordion, accordion-section, stepper, pagination — Guide-Doc (EN+DE) + 1–3 Import-Beispiele + locales-Hilfe (en-US+de) je Knoten"
epic: aspects/docs
status: pending
dependencies: [P265]
verify: browser
