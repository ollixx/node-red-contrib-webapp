...
| `writeTrigger` | „Write Trigger" | SelectBox (`change` / `submit`) | optional | Default `submit`; bei einer Radiogruppe ohne Wirkung — es wird effektiv immer bei `change` geschrieben (nie „nie"). |
