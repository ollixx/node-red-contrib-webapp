...
| `writeTrigger` | „Write Trigger" | SelectBox (`change` / `submit`) | optional | Default `submit`; bei einem Switch ohne Wirkung — es wird effektiv immer bei `change` geschrieben (nie „nie"). |
