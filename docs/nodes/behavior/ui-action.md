...
Bei `targetMode: out-port` emittiert der Knoten eine Component-State-Message auf seinem Out-Port. Der App-Autor verdrahtet diesen Port mit dem Ziel-Knoten. Format siehe [messages.md](../concepts/messages.md).
